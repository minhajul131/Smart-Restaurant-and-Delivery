    ...
    <div class="manage">
        <div class = "wrapper">
            ...
            <?php 
                ...
                $sql="SELECT * FROM order_delivery WHERE order_id=$order_id";
                ...
                if($res==TRUE){
                    ...
                    if($count==1){
                        ...
                        header('location:'.SITEURL.'admin/order_delivery.php');
                    }
                }
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="order_status">
                                ...
                                <option <?php if($order_status=="shipped"){echo "selected";} ?> value="shipped">shipped</option>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql2 = "UPDATE order_delivery SET `order_id`='$order_id',
